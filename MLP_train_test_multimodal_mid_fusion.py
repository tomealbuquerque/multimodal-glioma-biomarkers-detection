...
parser = argparse.ArgumentParser(description='Multimodal MRI + Path - MLP aggregator - mid fusion')
...
parser.add_argument('--model_PATH', type=str, default='0_WSI_embedder_weights/checkpoint_best_512_bin_fold_1.pth', help='path to trained model checkpoint')
parser.add_argument('--model_MRI', type=str, default='0_MRI_embedder_weights\multiclass_t1ce_flair\multiclass_fold1_t1ce_flair\multiclass_checkpoint_best_tiles.pth', help='path to trained model checkpoint')
...
def main():
    ...
    for epoch in range(args.nepochs):
        ...
        if val_err > best_loss:
            ...
            #     Phat =  Phat
            # else:
            #     Phat = [probs[i].argmax(0) for i in range(len(probs))]
