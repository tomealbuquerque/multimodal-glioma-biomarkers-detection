...
parser.add_argument('--tile_size', type=int, choices=[224,512,1024],default=4096)
parser.add_argument('--threshold_otsu_tiles', type=float ,default=0.05)
parser.add_argument('--folds', type=int, choices=range(5),default=5)
parser.add_argument('--seed', type=int,default=1234)
parser.add_argument('--name_file', type=str, default="multimodal_glioma_data_4096_.pickle")
...
for idx,pat in enumerate(df_clean['subject_id']):
    ...
    X_full_data.append({'flair':image_modalilty[0],
                        ...
                        'slide':os.path.basename(df_clean.loc[idx,'slide_id']),
    ...
    print("number_of_tiles:", len(X_full_data[idx]["tiles_coords"]))
