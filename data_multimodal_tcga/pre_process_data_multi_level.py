...
for idx,pat in enumerate(df_clean['subject_id']):
    ...
    X_full_data.append({'flair':image_modalilty[0],
                        ...
                        'tiles_coords_level':get_tiles(slide_path=os.path.join("E:\Pathology",df_clean.loc[idx,'slide_id']),
                                                 tile_size=args.tile_size_level, threshold_for_otsu=args.threshold_otsu_tiles),
